...
from clideps.pkgs.platforms import PLATFORM, Platform
from clideps.ui.rich_output import format_name_and_value, format_success_or_failure, rprint
from clideps.ui.styles import EMOJI_WARN
...
@cached(TTLCache(maxsize=1, ttl=5.0))  # pyright: ignore
